...
class Card extends Controller
{
    ...
    public function add_card()
    {
        if ($this->request->isAjax()) {
            $post = $this->postData();
            $dataP = Product::field(['id as p_id', 'i_id', 'condition', 'name', 'price', 'b_id', 'type', 'type_t', 'num', 'prices','code','sixm','ninem','twelvem'])->where(['id' => $post['pkid']])->find();
            $data['ctime'] = time();
            ...
            $data['code'] = $dataP['code'];
            $data['sixm'] = $dataP['sixm'];
            $data['ninem'] = $dataP['ninem'];
            $data['twelvem'] = $dataP['twelvem'];
