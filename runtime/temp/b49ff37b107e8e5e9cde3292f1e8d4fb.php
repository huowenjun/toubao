<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"F:\toubao\toubao\public/../application/admin\view\detection\update_insure.html";i:1547193808;s:59:"F:\toubao\toubao\application\admin\view\layouts\layout.html";i:1546682487;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="layui-tab-content" style="height: auto;">
            ...
            <div class="layui-tab-item wk">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" id="order_status" style="text-align: left">
                        <span class="order_status"><?php echo $data['order_status']; ?></span>
                        <select name="i_id" class="layui-input os" style="display: none">
...
<script>
    ...
    $(".os").change(function(){
        var sel = $(this);
        var sel_prev = sel.prev().html();//原本的值
        var sel_now = sel.val();//选择后的值
        var id = $('#id').val();//数据ID
        $.ajax({
            type: "POST",
            url: "updateDetection",
            data: {'id':id,'sel_now':sel_now,'sel_prev':sel_prev},
