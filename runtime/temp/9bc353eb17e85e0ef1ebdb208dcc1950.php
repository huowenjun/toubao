<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\toubao\toubao\public/../application/admin\view\tstore\index.html";i:1546831644;s:59:"F:\toubao\toubao\application\admin\view\layouts\layout.html";i:1546682487;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<fieldset class="layui-elem-field layui-field-title" >
		...
		<div style="text-align: left;">
			<form class="layui-form layui-form-pane" action="">
				<?php if(in_array(41, $role_operation_ids)): ?>
				<div class="layui-inline">
					<a href="addTstore.html" class="layui-btn layui-btn-sm layui-btn-normal">增加检测店</a>
				</div>
				<?php endif; ?>
	...
	<table class="layui-table" >
		...
		<tr>
			...
			<td>
				...
				<a class="rha-bt-a" href="upTstore.html?id=<?php echo $vo['id']; ?>">修改</a>
				<?php endif; if(in_array(43, $role_operation_ids)): ?>
